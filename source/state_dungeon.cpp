...
void update_dungeon_state() {
    ...
    prepare_for_ui_render(); // @Dungeon UI Render
    {
        ...
        foreach(i, 4) {
            //draw the spell icons in the boxes
            if(d->player.attack.type == ATTACK_fireball){
                draw_ui_texture(&textures[TEX_icons], v4(d->player.attack.type*8, 0, 8, 8),
                                v4(window_w - 4*64 + d->player.attack.type*64 + 8, window_h - 60 + 4, 8*4, 8*4));

                            draw_ui_texture(&textures[TEX_icons], v4(1*8, 8, 8, 8),
                                v4(window_w - 4*64 + 1*64 + 8, window_h - 60 + 4, 8*4, 8*4));
                            draw_ui_texture(&textures[TEX_icons], v4(2*8, 8, 8, 8),
                                v4(window_w - 4*64 + 2*64 + 8, window_h - 60 + 4, 8*4, 8*4));
                            draw_ui_texture(&textures[TEX_icons], v4(3*8, 8, 8, 8),
                                v4(window_w - 4*64 + 3*64 + 8, window_h - 60 + 4, 8*4, 8*4));

            } else if(d->player.attack.type == ATTACK_lightning){
                draw_ui_texture(&textures[TEX_icons], v4(d->player.attack.type*8, 0, 8, 8),
                                v4(window_w - 4*64 + d->player.attack.type*64 + 8, window_h - 60 + 4, 8*4, 8*4));

                            draw_ui_texture(&textures[TEX_icons], v4(0*8, 8, 8, 8),
                                v4(window_w - 4*64 + 0*64 + 8, window_h - 60 + 4, 8*4, 8*4));
                            draw_ui_texture(&textures[TEX_icons], v4(2*8, 8, 8, 8),
                                v4(window_w - 4*64 + 2*64 + 8, window_h - 60 + 4, 8*4, 8*4));
                            draw_ui_texture(&textures[TEX_icons], v4(3*8, 8, 8, 8),
                                v4(window_w - 4*64 + 3*64 + 8, window_h - 60 + 4, 8*4, 8*4));
